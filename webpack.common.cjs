...
module.exports = {
  entry: {
    ...
    // Add new map overlay toggle component
    'lib/components/map-overlay-toggle-new/map-overlay-toggle-new': './lib/components/map-overlay-toggle-new/map-overlay-toggle-new.ts',
