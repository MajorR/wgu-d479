...
export class SimpleMapOverlay extends IMapOverlay {
     ...
     */
    containsPoint(x, y, centerX, centerY, panX, panY, zoomScale, mapWidth, mapHeight) {
        const { x: screenX, y: screenY } = this.getScreenCoordinates(centerX, centerY, panX, panY, zoomScale, mapWidth, mapHeight);
    ...
    renderText(ctx, x, y, radius) {
        ...
        ctx.fillRect(x - textWidth / 2 - padding, y + radius + 5 - padding, textWidth + padding * 2, textHeight + padding * 2);
        // Draw text
        ctx.fillStyle = 'black';
