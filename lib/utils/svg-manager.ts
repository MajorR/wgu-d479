...
export class SVGManager {
  ...
  private svgDictionary: Map<string, string> = new Map();
  ...
  public addSVG(id: string, svg: string): void {
   ...
   */
  async getColoredSVG(path: string, color: string): Promise<string> {
   ...
   */
  async getImage(path: string, color?: string): Promise<HTMLImageElement> {
